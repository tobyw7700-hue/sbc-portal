...
class PetPage(tk.Frame):
    ...
    def _switch_tab(self, key):
        ...
        {"pet": self._build_pet, "crates": self._build_crates,
         ...
         "pet_index":    self._build_pet_index,
    ...
    def _build_pet_index(self):
        """Embed the Collection Index inside the My Pet tab."""
        from ui.index_page import IndexPage
        page = IndexPage(self.tab_content,
                         data=self.data, session=self.session)
