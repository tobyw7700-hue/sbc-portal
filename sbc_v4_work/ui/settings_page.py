...
class SettingsPage(tk.Frame):
    ...
    def _save_theme(self, name):
        try:
            ...
            if self.app and hasattr(self.app, "_current_page"):
                self.app._navigate(self.app._current_page)
            import tkinter.messagebox as mb
            mb.showinfo("Theme Applied", f"Theme changed to '{THEMES[name]['name']}' — applied instantly!")
        except Exception:
            pass
